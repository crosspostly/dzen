...
export interface ChannelConfig {
  ...
  modelOutline: string;        // gemini-3.1-flash-lite (or custom)
  modelEpisodes: string;       // gemini-3.1-flash-lite (or custom)
...
export const DZEN_CONFIG: ChannelConfig = {
  ...
  modelOutline: 'gemini-3.1-flash-lite',
  modelEpisodes: 'gemini-3.1-flash-lite',
